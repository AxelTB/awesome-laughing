...
suspend_cmd = "sudo s2disk"
-- user defined
browser    = "google-chrome"
browser2   = "iron"
gui_editor = "gedit"
graphics   = "gimp"
mail       = "google-chrome https://inbox.google.com"
...
-- {{{ Tags
dofile(os.getenv("HOME") .. "/.config/awesome/tyrannicalRule.lua")
-- }}}
...
for s = 1, screen.count() do
    ...
    local bottomrightlayout, bottomleftlayout = wibox.layout.fixed.horizontal(), wibox.layout.fixed.horizontal()
...
-- {{{ Key bindings
dofile(os.getenv("HOME") .. "/.config/awesome/keyBinding.lua")
-- }}}
